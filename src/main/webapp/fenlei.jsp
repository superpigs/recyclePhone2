            ...
            <div class="search_main">
                ...
                <div class="pageStr">
                    <div class="ihuigo_page">
                        <c:if test="${page.pageCount > 6}"><span><a href="<c:url value='brand/findByBrand/${brandId}/1'/>">首页</a></span></c:if>
                        <c:if test="${page.pageNo > 1}">
                            <span><a href="brand/findByBrand/${brandId}/${page.pageNo - 1}">上一页</a></span>
                        </c:if>
                        <c:choose>
                        ...
                        <c:forEach begin="${begin }" end="${end }" var="i">
                            <c:choose>
                                ...
                                <c:otherwise><span><a href="<c:url value='brand/findByBrand/${brandId}/${i}'/>">${i} </a></span></c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:if test="${page.pageNo < page.pageCount }">
                            <span><a href="<c:url value='brand/findByBrand/${brandId}/${page.pageNo + 1}'/>">下一页</a></span>
                        </c:if>
                        <c:if test="${page.pageCount > 6}"><span><a href="<c:url value='brand/findByBrand/${brandId}/${page.pageCount}'/>">尾页</a></span></c:if>
                    </div>
                </div>
                </c:if>
            </div>
