...
<form name="myFrom" id="myFrom" method="post" action="">
    ...
    <div class="contanier page">
            ...
            <div class="ihuigo">
                ...
                <div class="sub_con_top">
                    ...
                    <c:forEach items="${addressList}" var="address">
                    	 <div class="contanct_c check" name="item_member_addr" id="item_member_addr_0${address.addressId}">
                       	 <label>
                            <input type="radio" name="member_addr" value="0" checked="checked" onClick="new_member_addr('${address.addressId}')" />
                            <span>${address.userName}&nbsp;&nbsp;${address.userTel}&nbsp;&nbsp;${address.contactAddress}</span>
                            <input type="hidden" value="${address.addressId}"></label>
                    	</div>
                    </c:forEach>
      ...
      您可选择<a href="" style="background:none; padding:0px; color:#03F; font-weight:bold;" target="_blank">参与中国人民财产保险投保计划</a></span>
            ...
            <input type="button" name="sub_button" id="sub_button" value="提交回购单" class="input_btn2" onclick="abc()" />
        </div>
    ...
    <div class="dingdan">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
            ...
            <tr>
	                <td height="95" align="center">
	                    <div class="contact_way_img"><img style="width:56px;height:42px" src="images/phone/${order.telModel.image}"></div>
	                    <div class="contact_way_txt"><p><span>${order.telModel.modelName}</span></p></div>
	                    <div class="clear"></div>
	                </td>
                ...
                <td style="padding-left:28px; line-height: 18px;text-align: left;">
                	<c:forEach items="${order.subAttrs}" var="detail">
                		<a>${detail.subName}</a>|&nbsp;&nbsp;
                        <input type="hidden" name="property[]" value="${detail.subId}"/>
                	</c:forEach>
                </td>
            </tr>
        ...
        <div class="foot_bor"> <em id="sumCount">1</em>件产品总计回收价格<em id="sumPrice" style="font-size:18px;">${order.orderPrice}</em> <!--<span>赠送环保券 <i>30</i>元--></div>
    </div>
    <!--订单-->
    </div>
    <!--提交订单-->
...
<script type="text/javascript">
    function abc(){
        ...
        window.location.href="person/submit?orderPrice=${order.orderPrice}&addressId="+addressId+"&modelId=${order.telModel.modelId}&subTyIds="+subTyIds;
    }
</script>
